...
```bash
cat > .env <<'EOF'
MEDIASTATION_IMAGE_TAG=MediaStationGo-v0.0.30
...
| --- | --- |
| Linux x86_64 | `MediaStationGo-v0.0.30-linux-amd64.tar.gz` |
| Linux ARM64 | `MediaStationGo-v0.0.30-linux-arm64.tar.gz` |
| Windows x86_64 | `MediaStationGo-v0.0.30-windows-amd64.zip` |
| macOS Intel | `MediaStationGo-v0.0.30-darwin-amd64.tar.gz` |
| macOS Apple Silicon | `MediaStationGo-v0.0.30-darwin-arm64.tar.gz` |

Linux example:

```bash
tar -xzf MediaStationGo-v0.0.30-linux-amd64.tar.gz
cd MediaStationGo-v0.0.30-linux-amd64
...
```powershell
Expand-Archive .\MediaStationGo-v0.0.30-windows-amd64.zip
cd .\MediaStationGo-v0.0.30-windows-amd64
